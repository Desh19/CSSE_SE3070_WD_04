    ...
    <div>
        ...
        <Header/>
            ...
            <div className='regArea'>
                ...
                <button class='btn btn-primary' onClick={sendData}><Link to ="/UserLogin" 
                style={{textDecoration:'none', color:'white'}}>Register</Link></button>

                <hr/>
                <p className='bottm'>Already have an account? <Link className="nav-link active" aria-current="page" to="/UserLogin">Login</Link></p>
